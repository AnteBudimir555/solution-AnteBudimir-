...
namespace Middleware.IntegrationTests.Support;

/// <summary>
/// Shared domain fixtures for the API integration tests — the analog of the Java suite's
/// <c>support.TestData</c>. Keeps the many-field <see cref="Product"/> constructor out of individual
/// tests so they can focus on the fields that matter to each case.
/// </summary>
